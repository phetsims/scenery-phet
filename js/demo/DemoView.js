...
define( function( require ) {
  ...
  function DemoView() {
    ...
    // measuring tape
    var mtScaleProperty = new Property( 0.5 );
    var mtScaleSlider = new HSlider( mtScaleProperty, {min: 0.5, max: 2} );
    ...
    var measuringTape = new MeasuringTape( modelViewTransform, mtUnitsProperty, new Property( true ),
      {
        ...
        scaleProperty: mtScaleProperty
      } );
    this.addChild( measuringTape );
    this.addChild( mtScaleSlider );
    ...
    var refreshButtonLabel = new Text( 'Refresh Button: ', {
    ...
    var returnToLevelSelectButtonLabel = new Text( 'Return to Level Selection Button: ', {
      font: BUTTON_CAPTION_FONT,
    ...
    var soundToggleButtonLabel = new Text( 'Sound Toggle Button: ', {
      font: BUTTON_CAPTION_FONT,
    ...
    var timerToggleButtonLabel = new Text( 'Timer Toggle Button: ', {
      font: BUTTON_CAPTION_FONT,
