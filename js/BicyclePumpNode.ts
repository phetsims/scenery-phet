...
type SelfOptions = {
  ...
  dragListenerOptions?: StrictOmit<RichPointerDragListenerOptions, 'drag' | 'tandem'>;
...
export default class BicyclePumpNode extends Node {
  ...
  private readonly dragListener: RichPointerDragListener;
  ...
  public constructor( numberProperty: TProperty<number>,
    ...
    this.dragListener = new RichPointerDragListener( combineOptions<RichPointerDragListenerOptions>( {
...
/**
 * DragDelegate handles the drag action for the pump handle. The RichPointerDragListener and RichKeyboardDragListener instances
...
class DragDelegate {
  ...
  /**
   * Handles a drag of the pump handle. RichPointerDragListener and RichKeyboardDragListener instances in BicyclePumpNode
